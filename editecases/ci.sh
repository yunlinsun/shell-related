...
portal_dir="/home/steven/project/liferay-portal-ee-7.1.x" # Your portal dir ## Example for windows: portal_dir="/d/liferay-portal"
...
LINE_NUM6=$(($(grep -n " # Analytics Cloud" $test_properties | cut -f1 -d:)-3))
