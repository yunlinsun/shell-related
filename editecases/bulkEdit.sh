...
portal_dir="/home/steven/project/liferay-portal-ee-7.2.x" # Your portal dir ## Example for windows: portal_dir="/d/liferay-portal-ee-7.2.x"
...
do
	...
	string=`grep -A 5 "test $macroname " $file`
